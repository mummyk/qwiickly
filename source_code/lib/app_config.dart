...
class AppConfig {
  static String copyright_text = "@ qwiikly Ltd. " + this_year; //this shows in the splash screen
  static String app_name = "Qwiikly"; //this shows in the splash screen
  static String purchase_code = "24eaa652-3855-4c6f-95ad-186348fd9a40"; //enter your purchase code for the app from codecanyon
