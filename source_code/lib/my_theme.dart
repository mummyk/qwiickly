...
class MyTheme {
  ...
  static Color accent_color = Color.fromRGBO(5, 117, 186, 1);
  static Color soft_accent_color = Color.fromRGBO(247, 189, 168, 1);
  static Color splash_screen_color = Color.fromRGBO(
      5, 117, 186, 1); // if not sure , use the same color as accent color
  ...
  static Color black = Color.fromARGB(255, 0, 0, 1);
  static Color light_grey = Color.fromRGBO(193, 193, 193, 1);
  ...
  static Color textfield_grey = Color.fromRGBO(140, 140, 140, 1);
